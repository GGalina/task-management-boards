...
export const moveCard = async (
    ...
    try {
        ...
        if (!fromColumn || !toColumn) throw new HttpError(400, 'Missing required fields');
        ...
        if (!sourceCol || !targetCol) throw new HttpError(400, 'Column not found');
        ...
        if (typeof toIndex === 'number' && toIndex >= 0 && toIndex <= targetCol.cards.length) {
